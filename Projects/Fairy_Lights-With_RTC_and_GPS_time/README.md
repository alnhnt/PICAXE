...
* [Electronics\_Schematic](./Pictures/FairyLights_RTCandGPS_5Schematic.png), produced in KiCad v8.0.6.
* [Circuit\_Board\_Layout](./Pictures/FairyLights_RTCandGPS_6Board_Topside.png), based on stripboard and produced in VeroRoute v2.39 from the KiCad netlist.
